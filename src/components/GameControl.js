    ...
    return (
      ...
      <Parallax ref={(ref) => (this.parallax = ref)} pages={5}>
            ...
            <div className="container">
              <h1 style={{
                ...
                textShadow: '4px 4px gray'
                  ...
                  Billboard Baggins asks their buddy Grumbledorf what the issue is with their bug, but comes up with no wisdom... who else could have such wisdom?
                </h1>
            </div>
          </ParallaxLayer>
          <ParallaxLayer
          ...
          <ParallaxLayer
            ...
            <img style={{zIndex: '0', height: '200px', width: 'auto', borderRadius: "80%", opacity: '80%', marginLeft: '60%'}} src={GoBackToBed} alt="A cartoon of a young girl sleeping on a whale floating through space"></img>
          </ParallaxLayer>
          <ParallaxLayer
            offset={4.5}
            speed={0.1}
            ...
            <div style={{ justifyContent: 'space-between',textAlign: 'center', position: 'relative'}}>
              <button
                style={{
                  backgroundColor: 'rgba(157, 34, 157, 0.8)',
                  height: '100px',
                  width: '100px',
                  borderRadius: '50%',
                  marginBottom: '100px'}}
                id="btn"
                onClick={() => this.parallax.scrollTo(1.0)}>
                Start the day over!
              </button>{" "}
            </div>
          </ParallaxLayer>
